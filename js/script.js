...
async function cargarContenido() {
    ...
    // ✅ Categorías conocidas - solo agregar aquí si es categoría, no marca
    ...
    try {
        ...
        if (pagina === "index.html" || pagina === "") {
            ...
            // CATEGORÍA: maquillaje, capilares, etc.
            ...
            // ✅ MARCA: cualquier página que no sea index ni categoría
            // (magikal, fantiluna, nuevamarca, etc.) se detecta automáticamente
